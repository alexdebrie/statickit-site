      ...
      <main>
        ...
        <div className="mx-auto px-6 pt-12 container">
          <div className="pt-6 md:pt-10 pb-12 md:pb-16">
            <h1 className="pb-2 text-4xl md:text-5xl font-semibold leading-tight tracking-snug text-center">
              Pricing
            </h1>
          ...
          <div className="md:flex max-w-5xl mx-auto border-t border-b">
            <div className="px-6 py-16 md:w-1/2 border-b md:border-b-0 md:border-r">
              <h2 className="text-center text-sm uppercase font-bold tracking-wide text-indigo-600">Sandbox</h2>
              <div className="text-center text-4xl md:text-5xl tracking-tight font-semibold">
                Free
              </div>

              <p className="text-center text-base text-gray-700">For light personal use and testing.</p>
              <p className="text-center text-base text-gray-700">Up to 100 form submissions / month.</p>
              <p className="pb-2 text-center text-base text-gray-700">Unlimited forms.</p>
            </div>
            <div className="px-6 py-16 md:w-1/2">
              ...
              <p className="text-center text-base text-gray-700">For businesses and agencies.</p>
              <p className="text-center text-base text-gray-700">Up to 1,000 form submissions / month.</p>
              <p className="pb-2 text-center text-base text-gray-700">Unlimited forms.</p>
