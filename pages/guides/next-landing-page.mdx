...
export default withGuide({
  title: 'Building a Landing Page with StaticKit & Next.js',
  description:
    "In this guide, you'll learn how to create a simple landing page to gather email addresses using StaticKit and Next.js"
});

# Building a Landing Page with StaticKit & Next.js

In this guide, you'll learn how to create a simple landing page to gather email addresses using StaticKit and [Next.js](https://nextjs.org/).
...
You should see a "Welcome to Next.js" when you open [`http://localhost:3000/`](http://localhost:3000/) in your browser.

## Step 2: Design your landing page

Go ahead and replace the contents of the `pages/index.js` file with the following:
...
Here we are using the [Tailwind CSS](https://tailwindcss.com/) framework to style the page. The `<form>` tag is not yet wired up to anything -- that's coming next!

## Step 3: Create your form in StaticKit
...
## Step 4: Wire up your landing page

From your project directory, run this command:

```bash
yarn add @statickit/react
```
