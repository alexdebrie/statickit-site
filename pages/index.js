...
function MyForm() {
  ...
  return (
    <div className="antialiased">
      <main>
        <Head>
          <meta property="og:title" content="Simple form hosting for static sites" />
          <meta property="og:locale" content="en_US" />
          <meta name="description" content="Architected for developer happiness. Coming July 2019." />
          <meta property="og:description" content="Architected for developer happiness. Coming July 2019." />
          ...
          <meta property="og:image" content="https://www.statickit.com/static/logo-300.png" />
        </Head>
          ...
          <div className="pb-16 sm:pb-32 flex flex-wrap">
            ...
            <div className="px-6 w-full sm:w-1/2 xl:w-3/5">
              <div className="mb-2 p-4 w-full rounded-lg text-sm leading-relaxed overflow-auto bg-code">
                <CodeBlock className="language-jsx">{sampleCode.trim()}</CodeBlock>
              </div>
            </div>
          </div>
        </div>
